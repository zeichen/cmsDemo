    ...
    <div className="repeater-header">
      ...
      <div className="repeater-header-right">
        <div className="btn-group selectlist repeater-filters" data-resize="auto">
          ...
          <input className="hidden hidden-field" name="filterSelection" readonly="readonly" aria-hidden="true" type="text"/>
        </div>
        <div className="btn-group repeater-views" data-toggle="buttons">
          <label className="btn btn-default active">
            <input name="repeaterViews" type="radio" value="list"><span className="glyphicon glyphicon-list"></span>
          </label>
          <label className="btn btn-default">
            <input name="repeaterViews" type="radio" value="thumbnail"><span className="glyphicon glyphicon-th"></span>
          </label>
        </div>
      </div>
    </div>
    ...
    <div className="repeater-footer">
      ...
      <div className="repeater-footer-right">
        <div className="repeater-pagination">
          ...
          <input type="text" className="form-control repeater-secondaryPaging" aria-labelledby="myPageLabel">
